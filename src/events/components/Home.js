      ...
      <div className={classes.card}>
          ...
          <div className={classes.glass}>
            <div className={classes.coverImageContainer}>
              ...
              <Hidden only={['md', 'lg', 'xl']}>
                <img className={classes.headerImg} src={event.mobile_cover_picture} alt="Coding Ninjas" />
              </Hidden>
              <Hidden only={['xs', 'sm']}>
                <img className={classes.headerImg} src={event.cover_picture} alt="Coding Ninjas" />
              </Hidden>
            </div>
          </div>
        ...
        <footer className={classes.footer}>
          ...
          {event.event_sub_category != 'Archived' && event.registration_status == 'REGISTRATIONS_OPEN' && !event.user_already_registered ? <div className={classes.status}>
            ...
            <button className={classes.rButton}>Register Now</button>
          </div> : <></>}
